...
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'loongcy03@gmail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'loongcy03@gmail.com')
...
def process_receipt_with_textract(bucket, key):
    ...
    # Initialise receipt data dictionary
    receipt_data = {
            ...
            for group in expense_doc['LineItemGroups']:
                if 'LineItems' in group:
                    for line_item in group['LineItems']:
                        ...
                        # Add to items list if there's name
                        if 'name' in item:
